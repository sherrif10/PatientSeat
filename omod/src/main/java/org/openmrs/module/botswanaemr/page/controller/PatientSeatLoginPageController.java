...
//import static org.openmrs.module.patientseat.constants.USER_PROPERTY_CURRENTLY_LOGGED_FACILITY;
//import static org.openmrs.module.patientseat.constants.VISIT_LOCATION_TAG_NAME;
 ...
 */
@Controller
public class PatientSeatLoginPageController {
	...
	public String get(PageModel model, UiUtils ui, PageRequest pageRequest,
		...
		if (Context.getAuthenticatedUser() != null) {
			...
			// Context.getAuthenticatedUser().getUserProperty(USER_PROPERTY_CURRENTLY_LOGGED_FACILITY,
			    Context.getAdministrationService().getGlobalProperty("patientseat.hospital"));
		}
		...
		try {
			...
			model.addAttribute("locations",
			    locationService.getLocationsByTag(locationService.getLocationTagByName(VIEW_LOCATIONS)));
