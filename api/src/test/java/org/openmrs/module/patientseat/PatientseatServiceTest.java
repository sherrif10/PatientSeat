...
// import org.openmrs.module.patientseat.api.impl.PatientseatServiceImpl;
...
// 	@InjectMocks
// 	PatientseatServiceImpl basicModuleService;
...
// 		when(((PatientseatServiceImpl) dao).saveItem(item)).thenReturn(item);
